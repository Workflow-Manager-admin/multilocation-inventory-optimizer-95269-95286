          ...
          <div className="flex items-center">
            ...
            <div className="flex-shrink-0 flex items-center ml-2 lg:ml-0">
              <Link href="/" className="flex items-center">
                ...
                <span className="ml-2 text-lg sm:text-xl font-bold text-gray-900 dark:text-white truncate max-w-[120px] sm:max-w-none">
                  <span className="hidden sm:inline">Inventory Optimizer</span>
